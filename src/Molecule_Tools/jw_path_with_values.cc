...
Path_with_values::Path_with_values(atom_number_t a1, atom_number_t a2, double* values,
                                   int n_atoms) {
  _length = 2;
  _a1 = a1;
  _a2 = a2;
...
Path_with_values::Path_with_values(atom_number_t a1, atom_number_t a2,
                                   atom_number_t middle_atom, double* values,
                                   int n_atoms) {
  _length = 3;
  _a1 = a1;
  _a2 = a2;
...
Path_with_values::Path_with_values(const Path_with_values& p, atom_number_t a1,
                                   atom_number_t a2, double* values) {
  _length = p._length + 2;
...
void
Path_with_values::set_number_values(int number_values) {
  _number_values = number_values;
};

int
Path_with_values::number_values() {
  return _number_values;
};

int
Path_with_values::value(int i, double& value) {
...
void
Path_with_values::debug_print_path() {
  int n = _max_path_length;
  for (int i = 0; i < n; i++) {
...
Path_with_unsigned_int_values::Path_with_unsigned_int_values(atom_number_t a, int n_atoms,
                                                             unsigned int value1,
                                                             unsigned int value2,
                                                             unsigned int value3) {
  _length = 0;
...
Path_with_unsigned_int_values::Path_with_unsigned_int_values(
    const Path_with_unsigned_int_values& p, const Set_of_Atoms& a_set,
...
unsigned int
Path_with_unsigned_int_values::value1() {
  return _value1;
};

unsigned int
Path_with_unsigned_int_values::value2() {
  return _value2;
};

unsigned int
Path_with_unsigned_int_values::value3() {
  return _value3;
};

atom_number_t
Path_with_unsigned_int_values::outmost_layer_contains(int i) {
  return _outmost_layer[i];
};

void
Path_with_unsigned_int_values::set_atom_in_path(atom_number_t i) {
...
void
Path_with_unsigned_int_values::set_outpost_layer(atom_number_t i) {
  if ((i > -1) && (i < _max_path_length)) {
    _outmost_layer[i] = 1;
    _atom_numbers_in_path[i] = 1;
  }
...
int
Path_with_unsigned_int_values::contains(atom_number_t atom) {
  return _atom_numbers_in_path[atom];
};
