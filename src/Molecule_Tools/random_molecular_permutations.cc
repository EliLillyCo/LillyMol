...
class RandomState {
 ...
 public:
  ...
  template <typename T>
  int
  RandomInt(std::uniform_int_distribution<T>& dist) {
    return dist(_rng);
  }

  int
  OkProbability(const float threshold) {
...
int
Molecular_Transformation::report(std::ostream& output) const {
  output << _name << ' ' << _molecules_examined << ' ' << _molecules_changed << '\n';
...
class Molecular_Transformation_Change_Carbon_to_Nitrogen
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Change_Nitrogen_to_Carbon
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Change_Oxygen_to_Something
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Add_From_Single_Attachment_Library
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Add_From_Aromatic_Attachment_Library
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Add_From_Double_Attachment_Library
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Change_Ring_Substitution
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Remove_Terminal_Functional_Group
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
class Molecular_Transformation_Remove_Embedded_Functional_Group
    : public Molecular_Transformation {
 private:
  Iterate_Range _iter;
...
Molecular_Transformation_Add_Double_Bond::Molecular_Transformation_Add_Double_Bond(
    const char* s)
    : Molecular_Transformation(s) {
  _probability = probability_add_double_bond;

  return;
}

Molecular_Transformation_Remove_Atom::Molecular_Transformation_Remove_Atom(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Lower_Bond_Order::Molecular_Transformation_Lower_Bond_Order(
    const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Break_Aliphatic_Ring::
    Molecular_Transformation_Break_Aliphatic_Ring(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Make_Ring::Molecular_Transformation_Make_Ring(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Add_Carbon::Molecular_Transformation_Add_Carbon(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Move_Fragment::Molecular_Transformation_Move_Fragment(
    const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Swap_Adjacent_Atoms::
    Molecular_Transformation_Swap_Adjacent_Atoms(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Change_Carbon_to_Nitrogen::
    Molecular_Transformation_Change_Carbon_to_Nitrogen(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Change_Nitrogen_to_Carbon::
    Molecular_Transformation_Change_Nitrogen_to_Carbon(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Change_Carbon_to_Oxygen::
    Molecular_Transformation_Change_Carbon_to_Oxygen(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Change_Oxygen_to_Something::
    Molecular_Transformation_Change_Oxygen_to_Something(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Add_From_Single_Attachment_Library::
    Molecular_Transformation_Add_From_Single_Attachment_Library(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Add_From_Aromatic_Attachment_Library::
    Molecular_Transformation_Add_From_Aromatic_Attachment_Library(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Add_From_Double_Attachment_Library::
    Molecular_Transformation_Add_From_Double_Attachment_Library(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Change_Ring_Substitution::
    Molecular_Transformation_Change_Ring_Substitution(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Remove_Terminal_Functional_Group::
    Molecular_Transformation_Remove_Terminal_Functional_Group(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Remove_Embedded_Functional_Group::
    Molecular_Transformation_Remove_Embedded_Functional_Group(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Remove_Terminal_Ring::
    Molecular_Transformation_Remove_Terminal_Ring(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Switch_Aromatic_Ring::
    Molecular_Transformation_Switch_Aromatic_Ring(const char* s)
    : Molecular_Transformation(s) {
...
Molecular_Transformation_Switch_Aliphatic_Ring::
    Molecular_Transformation_Switch_Aliphatic_Ring(const char* s)
    : Molecular_Transformation(s) {
...
int
Molecular_Transformation_Add_Double_Bond::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Lower_Bond_Order::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Break_Aliphatic_Ring::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Swap_Adjacent_Atoms::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Change_Carbon_to_Nitrogen::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Change_Nitrogen_to_Carbon::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Change_Carbon_to_Oxygen::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Change_Oxygen_to_Something::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Add_From_Single_Attachment_Library::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Add_From_Aromatic_Attachment_Library::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Add_From_Double_Attachment_Library::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Change_Ring_Substitution::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Remove_Terminal_Functional_Group::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Remove_Embedded_Functional_Group::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Remove_Terminal_Ring::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Switch_Aromatic_Ring::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
int
Molecular_Transformation_Switch_Aliphatic_Ring::_do_transformation(
    Molecule& m, const Can_Change& can_change) {
  _molecules_examined++;
...
Transformations::Initialise(Command_Line& cl) {
  ...
  std::unordered_map<std::string, float> probabilities = Probabilities(_config);
...
#ifdef NOT_USED
static int
initialise_never_change_atoms(Molecule& m, Can_Change& can_change) {
...
static int
permutation_add_double_bond(Molecule& m, const int bond_number,
                            const Can_Change& can_change) {
...
static int
permutation_add_double_bond(Molecule& m, const Can_Change& can_change,
...
static int
any_undesirable_adjacencies(Molecule& m, atom_number_t a1, atom_number_t a2) {
  const Atom* aa1 = m.atomi(a1);
  const Atom* aa2 = m.atomi(a2);
...
static int
permutation_remove_atom(Molecule& m, const atom_number_t j,
                        const Can_Change& can_change) {
  ...
  if (m.in_ring_of_given_size(j,
                              minimum_ring_size_allowed + 1)) {  // smallest possible ring
    return 0;
  }
...
static int
permutation_remove_atom(Molecule& m, const Can_Change& can_change,
                        RandomState& random_state) {
...
static int
would_break_up_nice_group(const Molecule& m, atom_number_t a1, atom_number_t a2) {
  const Atom* aa1 = m.atomi(a1);
  const Atom* aa2 = m.atomi(a2);
  ...
  // If we have an oxygen bonded to something that has another heteroatom attached, keep
  // the double bond
...
static int
bonded_to_halogen(const Molecule& m, atom_number_t zatom) {
...
static int
permutation_lower_bond_order(Molecule& m, const int bnumber, const Can_Change& can_change,
                             RandomState& random_state) {
#ifdef FREQUENTLY_CHECK_VALENCES
  assert(m.valence_ok());
#endif
  ...
  if (b->is_aromatic()) {
    ...
    if (bonded_to_halogen(m, a1) ||
        bonded_to_halogen(m, a2)) {  // don't create alkyl halides
      return 0;
    }
...
#ifdef FREQUENTLY_CHECK_VALENCES
  if (!m.valence_ok()) {
    cerr << "Lowering bond order bad valence " << m.smiles() << '\n';
  }
  assert(m.valence_ok());
#endif
...
static int
permutation_lower_bond_order(Molecule& m, const Can_Change& can_change,
                             RandomState& random_state) {
#ifdef FREQUENTLY_CHECK_VALENCES
  assert(m.valence_ok());
#endif
...
static int
permutation_break_aliphatic_ring(Molecule& m, const int bond_number,
                                 const Can_Change& can_change) {
  const Bond* b = m.bondi(bond_number);
...
#ifdef FREQUENTLY_CHECK_VALENCES
  if (! m.valence_ok()) {
    cerr << "permutation_break_aliphatic_ring:invalid valence " << m.smiles() << '\n';
    return 0;
  }
#endif
...
static int
permutation_break_aliphatic_ring(Molecule& m, const Can_Change& can_change,
                                 RandomState& random_state) {
...
static int
count_aromatic_bonds(Molecule& m, atom_number_t astart, atom_number_t destination,
  ...
  for (int i = 0; i < acon; i++) {
    ...
    int ab =
        count_aromatic_bonds(m, j, destination, encountered_so_far + b->is_aromatic());
    if (ab > 1) {
      return ab;
    }
  }
...
static int
looks_like_different_parts_of_fused_system(Molecule& m, const atom_number_t a1,
  ...
  if (r1->fused_system_identifier() ==
      r2->fused_system_identifier()) {  // in same system, bad...
    return 1;
  }
...
static int
would_form_strained_aromatic(Molecule& m, const atom_number_t a1,
                             const atom_number_t a2) {
...
static int
would_form_three_membered_ring_with_heteroatom(Molecule& m, atom_number_t a1,
                                               atom_number_t a2) {
...
static int
permutation_make_ring(Molecule& m, const atom_number_t a1, const atom_number_t a2,
  ...
  if (m.bonds_between(a1, a2) <= minimum_ring_size_allowed - 1) {
    return 0;
  } else if (maximum_ring_size_allowed > 0 &&
             m.bonds_between(a1, a2) >= maximum_ring_size_allowed - 1) {
    return 0;
  ...
  if (can_form_strongly_fused_ring_systems) {
    ;
  } else if (m.rings_with_strongly_fused_ring_neighbours() >
             initial_strongly_fused_ring_count) {
    m.remove_bond_between_atoms(a1, a2);
    return 0;
  }
...
static int
permutation_make_ring(Molecule& m, const Can_Change& can_change,
                      RandomState& random_state) {
  ...
  if (max_rings_in_each_permutation > 0 &&
      m.nrings() + 1 >= max_rings_in_each_permutation) {
    return 0;
  }

  if (min_rings_in_each_permutation > 0 &&
      m.nrings() - 1 <= min_rings_in_each_permutation) {
    return 0;
  }
...
static int
permutation_change_nitrogen_to_carbon(Molecule& m, const atom_number_t j,
                                      const Can_Change& can_change) {
...
static int
permutation_change_nitrogen_to_carbon(Molecule& m, const Can_Change& can_change,
                                      RandomState& random_state) {
...
static int
singly_bonded_to_oxygen_or_nitrogen(const Molecule& m, const atom_number_t a) {
...
static int
alpha_to_oxygen_or_nitrogen(Molecule& m, const atom_number_t astart) {
  const Atom* a = m.atomi(astart);
...
static int
beta_to_oxygen_or_nitrogen(Molecule& m, const atom_number_t astart) {
  const Atom* a = m.atomi(astart);
...
static int
permutation_change_carbon_to_nitrogen(Molecule& m, const atom_number_t j,
                                      const Can_Change& can_change) {
...
static int
permutation_change_carbon_to_nitrogen(Molecule& m, const Can_Change& can_change,
                                      RandomState& random_state) {
...
static int
permutation_change_carbon_to_oxygen(Molecule& m, const atom_number_t j,
                                    const Can_Change& can_change) {
  if (6 != m.atomic_number(j)) {
    return 0;
  }
...
static int
permutation_change_carbon_to_oxygen(Molecule& m, const Can_Change& can_change,
                                    RandomState& random_state) {
...
static int
permutation_change_oxygen_to_something(Molecule& m, const atom_number_t j,
                                       const Can_Change& can_change,
                                       RandomState& random_state) {
  const Atom* aj = m.atomi(j);
...
static int
permutation_change_oxygen_to_something(Molecule& m, const Can_Change& can_change,
                                       RandomState& random_state) {
...
static int
permutation_add_carbon(Molecule& m, const atom_number_t j, const Can_Change& can_change) {
  if (0 == m.hcount(j)) {
    return 0;
  }
...
static int
permutation_add_carbon(Molecule& m, const Can_Change& can_change,
                       RandomState& random_state) {
...
static int
identify_chain_single_bond(Molecule& m, atom_number_t& a1, atom_number_t& a2,
                           RandomState& random_state) {
  const int matoms = m.natoms();
  ...
  for (int i = 0; i < max_attempts; i++) {
    ...
    for (int k = 0; k < jcon; k++) {
      ...
      //    don't make any checks, allow aldehydes to form, hopefully they'll disappear
      //    later

      //    if (m.is_aromatic(l))    // ok to break these
      //      ;
      //    else if (m.nbonds(l) > m.ncon(l))    // unsaturated group, don't break off
      //    from it - creates aldehydes and such
      //      continue;
...
static int
identify_join_atom_in_other_fragment(Molecule& m, const atom_number_t& a3,
                                     atom_number_t& a4, RandomState& random_state) {
  const int matoms = m.natoms();
...
static int
permutation_move_fragment(Molecule& m, const atom_number_t a1, const atom_number_t a2,
                          const Can_Change& can_change, RandomState& random_state) {
  if (!can_change[a1] || !can_change[a2]) {
    return 0;
  }
...
static int
permutation_move_fragment(Molecule& m, const Can_Change& can_change,
                          RandomState& random_state) {
...
/*
  Common code for swapping adjacent atoms. It can be called by the do and undo
  transformation A1-J-A2-A3 becomes A1-A2-J-A3
*/

static void
swap_adjacent_atoms(Molecule& m, const atom_number_t a1, const atom_number_t j,
                    const atom_number_t a2, const atom_number_t a3) {
  m.remove_bond_between_atoms(a1, j);
...
static int
violates_ring_size_constraints(Molecule& m, const atom_number_t a1, const atom_number_t j,
                               const atom_number_t a2, const atom_number_t a3) {
...
static int
any_undesirable_adjacencies(Molecule& m, const atom_number_t a1, const atom_number_t j,
                            const atom_number_t a2, const atom_number_t a3) {
  if (any_undesirable_adjacencies(m, a1, a2)) {
    return 1;
  }
...
static int
is_part_of_ring_system(Molecule& m, const atom_number_t zatom) {
  if (m.nrings(zatom) > 1) {
    return 1;
  }
...
static int
permutation_swap_adjacent_atoms(Molecule& m, const atom_number_t j,
                                const Can_Change& can_change) {
  if (m.is_aromatic(j)) {
    return 0;
  }
  ...
  for (int k = 0; k < jcon; k++) {
    ...
    if (al->atomic_number() == aj->atomic_number() && al->ncon() == aj->ncon() &&
        al->nbonds() == aj->nbonds()) {  // the look to be the same
      continue;
    }
  ...
  if (m.are_bonded(a1, a2) || m.are_bonded(j, a3) ||
      m.are_bonded(a1, a3)) {  // possible existing small ring
    return 0;
  }
  ...
  if (violates_ring_size_constraints(m, a1, j, a2, a3)) {  // will restore it if needed
    cerr << "Violated ring size constraints, now " << m.smiles() << '\n';
    return 0;
  }
...
// Identify a singly connected neighbour of `zatom`.
atom_number_t
get_connected_atom(const Atom* a, const atom_number_t zatom,
...
static int
permutation_swap_adjacent_atoms(Molecule& m, const int bond_number,
                                const Can_Change& can_change) {
  assert(m.valence_ok());
  ...
  if ((aa1->atomic_number() ==
       aa2->atomic_number()) &&  // nothing would change if we swapped them
      (aa1->ncon() == aa2->ncon()) &&
...
#ifdef FREQUENTLY_CHECK_VALENCES
  if (! m.valence_ok()) {
    cerr << "permutation_swap_adjacent_atoms:invalid valence " << m.smiles() << '\n';
...
static int
permutation_swap_adjacent_atoms(Molecule& m, const Can_Change& can_change,
                                RandomState& random_state) {
...
static int
any_undesirable_adjacencies(const Molecule& m1, atom_number_t a1, const Molecule& m2,
                            atom_number_t a2) {
...
choose_random_attachment_point(Molecule& m, RandomState& random_state) {
  const int matoms = m.natoms();
...
static int
permutation_add_from_single_attachment_library(Molecule& m, const atom_number_t j1,
                                               const Molecule* f,
  ...
  //   cerr << "random_atom_in_fragment produced " << m.smiles() << "' from '" <<
  //   f->smiles() << "'\n";
...
static int
permutation_add_from_single_attachment_library(Molecule& m, const Can_Change& can_change,
  ...
  for (int i = 0; i < max_attempts; i++) {
    ...
    Molecule* f = random_state.RandomItem(
        library);  // we do not change it, but choose_random_attachment_point uses some
                   // non const methods
...
permutation_add_from_single_attachment_library(Molecule& m, const Can_Change& can_change,
  ...
  return permutation_add_from_single_attachment_library(
      m, can_change, single_attachment_fragment_library_join_at_first_atom,
...
permutation_add_from_single_attachment_library_random_join(Molecule& m,
  ...
  return permutation_add_from_single_attachment_library(
      m, can_change, single_attachment_fragment_library_join_from_any_atom, 1,
      random_state);  // 1 means use random atom in fragment
}

static int
permutation_add_from_aromatic_attachment_library(Molecule& m, const atom_number_t j,
                                                 Molecule* f,
                                                 const Can_Change& can_change,
                                                 RandomState& random_state) {
  if (0 == m.hcount(j)) {
...
permutation_add_from_aromatic_attachment_library(Molecule& m,
  ...
  for (int i = 0; i < max_attempts; i++) {
    ...
    if (permutation_add_from_aromatic_attachment_library(
            m, j, random_state.RandomItem(aromatic_attachment_fragment_library),
...
static int
permutation_add_from_double_attachment_library(Molecule& m, const atom_number_t j,
                                               const Molecule* f,
  ...
  for (int k = 0; k < jcon; k++) {
    ...
    if (any_undesirable_adjacencies(m, j, *f, 0) ||
        any_undesirable_adjacencies(m, l, *f, star_atom)) {
      continue;
    }
...
static int
permutation_add_from_double_attachment_library(Molecule& m, const Can_Change& can_change,
                                               RandomState& random_state) {
  ...
  for (int i = 0; i < max_attempts; ++i) {
    const int n =
        random_state.RandomInt(double_attachment_fragment_library.number_elements() - 1);

    const Molecule* f = double_attachment_fragment_library[n];

    const atom_number_t j = random_state.RandomInt(matoms - 1);

    if (permutation_add_from_double_attachment_library(
            m, j, f, index_of_star_atom_attachment[n], can_change)) {
      return 1;
    }
  }
...
static int
permutation_change_ring_substitution(Molecule& m, const int r,
                                     const Can_Change& can_change) {
  ...
  if (!can_change[has_hydrogen] && !can_change[non_ring_bond1] &&
      !can_change[non_ring_bond2]) {
    return 0;
  }
...
#ifdef FREQUENTLY_CHECK_VALENCES
  if (! m.valence_ok()) {
    cerr << "Change ring substitution bad valence " << m.smiles() << '\n';
  }
#endif
...
static int
permutation_change_ring_substitution(Molecule& m, const Can_Change& can_change,
                                     RandomState& random_state) {
...
static int
identify_terminal_functional_group(Molecule& m, const atom_number_t xstart,
                                   Set_of_Atoms& s) {
  s.add(xstart);
...
/*
  Find a singly connected atom that is multiply bonded to something and look for a
  functional group to get rid of. Should trim things like cyano, acids, etc...
*/

static int
permutation_remove_terminal_functional_group(Molecule& m, const atom_number_t j,
                                             const Can_Change& can_change) {
  const Atom* aj = m.atomi(j);
  ...
  if (verbose > 2) {
    cerr << "Removed terminal functional group with " << s.number_elements()
         << " atoms\n";
  }
...
static int
permutation_remove_terminal_functional_group(Molecule& m, const Can_Change& can_change,
                                             RandomState& random_state) {
...
static int
remove_embedded_functional_group(Molecule& m, atom_number_t zstart) {
...
// #define DEBUG_EXCISE_FUNCTIONAL_GROUP
  ...
  for (const Bond* b : *am) {
    ...
    //  think of the Nitrogen in an amide. We want to remove the Nitrogen and identify the
    //  atom next in the chain from it
  ...
  m.add_bond(singly_connected_carbon1, singly_connected_carbon2,
             SINGLE_BOND);  // temporary invalid valence
  ...
  if (verbose > 2) {
    cerr << "Removed embedded functional group with " << s.number_elements()
         << " atoms\n";
  }
...
static int
permutation_remove_embedded_functional_group(Molecule& m, const atom_number_t j,
                                             const Can_Change& can_change) {
  if (!can_change[j]) {
    return 0;
  }
...
static int
permutation_remove_embedded_functional_group(Molecule& m, const Can_Change& can_change,
                                             RandomState& random_state) {
...
static int
all_terminal_atoms(Molecule& m, const atom_number_t afrom, const atom_number_t astart,
...
static int
can_also_be_removed(Molecule& m, const Ring& r, const atom_number_t astart,
                    Set_of_Atoms& to_be_removed) {
  const Atom* a = m.atomi(astart);
...
static int
permutation_remove_terminal_ring(Molecule& m, const int ring_number,
                                 const Can_Change& can_change) {
  ...
  if (verbose > 2) {
    cerr << "Removed " << to_be_removed.number_elements()
         << " atoms associated with terminal ring with " << ring_size << " atoms\n";
  }
...
static int
permutation_remove_terminal_ring(Molecule& m, const Can_Change& can_change,
                                 RandomState& random_state) {
...
static void
randomly_permute(Set_of_Atoms& s, RandomState& random_state) {
...
static int
next_after_wrap(int i, int imax) {
  i++;
...
#ifdef NOT_USED
static void
set_atoms_to_remove(const Ring& r, atom_number_t exclude1, atom_number_t exclude2,
...
static int
identify_doubly_bonded_atoms_in_ring(const Molecule& m, const Ring& r, atom_number_t& a1,
                                     atom_number_t& a2, RandomState& random_state) {
...
static int
permutation_create_fused_ring(Molecule& m, const Ring* ri, const Molecule* parial_ring,
                              const Can_Change& can_change, RandomState& random_state) {
  m.compute_aromaticity_if_needed();
...
#ifdef FREQUENTLY_CHECK_VALENCES
  if (!m.valence_ok()) {
    cerr << "permutation_create_fused_ring, formed bad valence '" << m.smiles() << '\n';
    abort();
  }
#endif
...
static int
permutation_create_fused_ring(Molecule& m, const Can_Change& can_change,
                              RandomState& random_state) {
...
static int
permutation_split_apart_fused_ring(Molecule& m, const int ring_number,
                                   const Can_Change& can_change,
                                   RandomState& random_state) {
  ...
  cerr << "Split apart fused rings, initial '" << initial_smiles << "' now '"
       << m.smiles() << "'\n";
#endif
...
static int
permutation_split_apart_fused_ring(Molecule& m, const Can_Change& can_change,
                                   RandomState& random_state) {
...
static int
switch_ring(Molecule& m, const Set_of_Atoms& ring_to_remove_arg, Molecule& ring_to_add,
            RandomState& random_state) {
  Set_of_Atoms ring_to_remove =
      ring_to_remove_arg;  // we need a copy because add_molecule destroys existing rings
  ...
  // Now the tricky part. We want to break all the bonds to the old ring, and re-make them
  // to atoms in the new ring. Note that any previous double bond will be converted to a
  // single bond
...
#ifdef FREQUENTLY_CHECK_VALENCES
  if (! m.valence_ok()) {
    cerr << "switch_ring generated bad valence " << m.smiles() << '\n';
  }
#endif
...
static int
permutation_switch_ring(Molecule& m, int aromatic_rings_only, Molecule& ring_to_add,
                        RandomState& random_state) {
  int nr = m.nrings();
...
static int
permutation_switch_aromatic_ring(Molecule& m, const Can_Change& can_change,
                                 RandomState& random_state) {
...
static int
permutation_switch_aliphatic_ring(Molecule& m, const Can_Change& can_change,
                                  RandomState& random_state) {
...
static int
find_random_single_bond(Molecule& m, const Can_Change& can_change,
                        RandomState& random_state) {
...
int
Molecular_Transformation_Add_Double_Bond::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_double_bond(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Atom::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_remove_atom(m, can_change, _random_state);
}

int
Molecular_Transformation_Lower_Bond_Order::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_lower_bond_order(m, can_change, _random_state);
}

int
Molecular_Transformation_Break_Aliphatic_Ring::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_break_aliphatic_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Make_Ring::random_transformation(Molecule& m,
                                                          const Can_Change& can_change) {
  return permutation_make_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_Carbon::random_transformation(Molecule& m,
                                                           const Can_Change& can_change) {
  return permutation_add_carbon(m, can_change, _random_state);
}

int
Molecular_Transformation_Move_Fragment::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_move_fragment(m, can_change, _random_state);
}

int
Molecular_Transformation_Swap_Adjacent_Atoms::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_swap_adjacent_atoms(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Carbon_to_Nitrogen::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_carbon_to_nitrogen(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Nitrogen_to_Carbon::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_nitrogen_to_carbon(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Carbon_to_Oxygen::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_carbon_to_oxygen(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Oxygen_to_Something::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_oxygen_to_something(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_From_Single_Attachment_Library::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_from_single_attachment_library(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_From_Aromatic_Attachment_Library::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_from_aromatic_attachment_library(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_From_Double_Attachment_Library::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_from_double_attachment_library(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Ring_Substitution::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_ring_substitution(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Terminal_Functional_Group::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_remove_terminal_functional_group(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Embedded_Functional_Group::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_remove_embedded_functional_group(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Terminal_Ring::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_remove_terminal_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Switch_Aromatic_Ring::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_switch_aromatic_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Switch_Aliphatic_Ring::random_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_switch_aliphatic_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_Double_Bond::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_double_bond(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Atom::next_transformation(Molecule& m,
                                                          const Can_Change& can_change) {
  return permutation_remove_atom(m, can_change, _random_state);
}

int
Molecular_Transformation_Lower_Bond_Order::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_lower_bond_order(m, can_change, _random_state);
}

int
Molecular_Transformation_Break_Aliphatic_Ring::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_break_aliphatic_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Make_Ring::next_transformation(Molecule& m,
                                                        const Can_Change& can_change) {
  return permutation_make_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_Carbon::next_transformation(Molecule& m,
                                                         const Can_Change& can_change) {
  return permutation_add_carbon(m, can_change, _random_state);
}

int
Molecular_Transformation_Move_Fragment::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_move_fragment(m, can_change, _random_state);
}

int
Molecular_Transformation_Swap_Adjacent_Atoms::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_swap_adjacent_atoms(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Carbon_to_Nitrogen::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_carbon_to_nitrogen(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Nitrogen_to_Carbon::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_nitrogen_to_carbon(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Carbon_to_Oxygen::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_carbon_to_oxygen(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Oxygen_to_Something::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_oxygen_to_something(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_From_Single_Attachment_Library::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_from_single_attachment_library(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_From_Aromatic_Attachment_Library::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_from_aromatic_attachment_library(m, can_change, _random_state);
}

int
Molecular_Transformation_Add_From_Double_Attachment_Library::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_add_from_double_attachment_library(m, can_change, _random_state);
}

int
Molecular_Transformation_Change_Ring_Substitution::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_change_ring_substitution(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Terminal_Functional_Group::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_remove_terminal_functional_group(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Embedded_Functional_Group::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_remove_embedded_functional_group(m, can_change, _random_state);
}

int
Molecular_Transformation_Remove_Terminal_Ring::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_remove_terminal_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Switch_Aromatic_Ring::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_switch_aromatic_ring(m, can_change, _random_state);
}

int
Molecular_Transformation_Switch_Aliphatic_Ring::next_transformation(
    Molecule& m, const Can_Change& can_change) {
  return permutation_switch_aliphatic_ring(m, can_change, _random_state);
}

static int
breed(Molecule& m, const Can_Change& can_change, Molecule& f, RandomState& random_state) {
#ifdef FREQUENTLY_CHECK_VALENCES
  assert(m.valence_ok());
  assert(f.valence_ok());
#endif
  ...
  } else if ((n1 + n4) >= lower_atom_count_cutoff &&
             (n1 + n4) <= upper_atom_count_cutoff &&
             (6 == m.atomic_number(a1) || 6 == m.atomic_number(a4))) {
    m.add_bond(a1, a4, SINGLE_BOND);
    m.add_bond(a2, a3, SINGLE_BOND);
    m.remove_fragment_containing_atom(a2);
  } else if ((n2 + n4) >= lower_atom_count_cutoff &&
             (n2 + n4) <= upper_atom_count_cutoff &&
             (6 == m.atomic_number(a2) || 6 == m.atomic_number(a4))) {
    m.add_bond(a2, a4, SINGLE_BOND);
    m.add_bond(a1, a3, SINGLE_BOND);
    m.remove_fragment_containing_atom(a1);
  } else if ((n2 + n3) >= lower_atom_count_cutoff &&
             (n2 + n3) <= upper_atom_count_cutoff &&
...
static int
permutation_breed(Molecule& m, const Can_Change& can_change, RandomState& random_state) {
...
#define NUMBER_KNOWN_PERMUTATIONS \
  (NUMBER_KNOWN_INTRA_PERMUTATIONS + NUMBER_KNOWN_INTER_PERMUTATIONS)

static int number_known_permutations = NUMBER_KNOWN_PERMUTATIONS;

static IWString permutation_name[NUMBER_KNOWN_PERMUTATIONS];
static int permutation_selected[NUMBER_KNOWN_PERMUTATIONS];
static int permutation_successful[NUMBER_KNOWN_PERMUTATIONS];
...
Molecule_and_Distance::Molecule_and_Distance(const Molecule& m, const float d)
    : Molecule(m), _dist(d) {
  return;
}
...
class Molecule_and_Distance_Comparator {
 ...
 public:
  bool
  operator()(const float d, const Molecule_and_Distance* m1) const
...
class Set_of_Closer_Molecules {
 ...
 public:
  ...
  Molecule*
  moleculei(const int s) {
    return _m[s];
  }

  void
  set_max_distance(const float s) {
    _max_distance = s;
  }
...
Set_of_Closer_Molecules::consider(Molecule& m, const float d) {
  ...
  // cerr << "Looking for " << d << " in " << _n << " items, iterator " << (f - _m) << "
  // short " << _m[0]->dist() << " long " << _m[_n-1]->dist() << '\n';
...
Set_of_Closer_Molecules::_check_sorted() const {
  for (int i = 1; i < _n; ++i) {
    if (_m[i - 1]->dist() > _m[i]->dist()) {
      cerr << "Set_of_Closer_Molecules::_check_sorted:out of order, i = " << i << " prev "
           << _m[i - 1]->dist() << " curr " << _m[i]->dist() << '\n';
      return 0;
    }
  }
...
// clang-format off
  ...
  cerr << "  -x <number>    number of copies of the starting molecule to use (" << nstart
       << ")\n";
  cerr << "  -p <perm>      number of permutations to make on each molecule (default "
  ...
  cerr << "  -G -<number>   maximum number of rings that can be removed from each "
          "molecule\n";
  cerr << "  -L single=<file>  library file of singly attached fragments - join at first "
          "atom\n";
  cerr << "  -L singleR=<file> library of singly attached fragments - join from any "
          "atom\n";
  cerr << "  -L double=<file>  library file of doubly attached fragments\n";
  cerr << "  -L arom=<file>    library file of fragments that are added only to aromatic "
          "rings\n";
  ...
  cerr << "  -K copy        write the initial molecule to the output before each copy "
          "(-s)\n";
  cerr << "  -K every       write the initial molecule to the output before every "
          "perturbation\n";
  ...
  cerr << "  -T <fname>     file of target molecules to try to make, enter -T help for "
          "info\n";
...
static int
permutation_breed_with_close_to_target(Molecule& m, const Can_Change& can_change,
                                       RandomState& random_state) {
...
static void
display_miscellaneous_options(const char c, std::ostream& output) {
  output << "  -" << c
         << " afras      allow fused ring atoms to swap atoms - can generate strange "
            "ring systems\n";
  output << "  -" << c
         << " cblast     the changed by string contains only the last permuation\n";
  output << "  -" << c
         << " okcage     will allow formation of strongly fused ring systems\n";
  ...
  output << "  -" << c
         << " scrand     all sidechains  will be attached via random atoms\n";
  output << "  -" << c
         << " ssintra    perform non random sequential scan of all intra molecular "
            "transformations\n";
...
template <typename T>
class Transformation_and_Atom_Iterator
    : public Transformation_and_Iterator<T, Iterate_Range> {
 private:
...
template <typename T>
Transformation_and_Atom_Iterator<T>::Transformation_and_Atom_Iterator(const Molecule& m,
                                                                      T& t)
...
template <typename T>
class Transformation_and_Bond_Iterator
    : public Transformation_and_Iterator<T, Iterate_Range> {
 private:
  using Transformation_and_Iterator<T, Iterate_Range>::_transform;
...
template <typename T>
Transformation_and_Bond_Iterator<T>::Transformation_and_Bond_Iterator(const Molecule& m,
                                                                      T& t)
    : Transformation_and_Iterator<T, Iterate_Range>(t),
...
template <typename T>
class Transformation_and_Ring_Iterator
    : public Transformation_and_Iterator<T, Iterate_Range> {
 private:
  using Transformation_and_Iterator<T, Iterate_Range>::_transform;
...
template <typename T>
class Transformation_Make_Ring : public Transformation_and_Iterator<T, Iterate_Range> {
 private:
  using Transformation_and_Iterator<T, Iterate_Range>::_transform;
...
Transformation_Make_Ring<T>::Transformation_Make_Ring(T& t, Molecule& m)
    : Transformation_and_Iterator<T, Iterate_Range>::_transform(
          Transformation_and_Iterator<T, Iterate_Range>(t)),
      Transformation_and_Iterator<T, Iterate_Range>::_iterator(
...
template <typename T>
class Transformation_Create_Fused_Ring
    : public Transformation_and_Iterator<T, Iterate_Range> {
 private:
  using Transformation_and_Iterator<T, Iterate_Range>::_transform;
  using Transformation_and_Iterator<T, Iterate_Range>::_iterator;
 ...
 public:
  Transformation_Create_Fused_Ring(T& t, Molecule& m,
                                   resizable_array_p<Molecule>& aromatic_ring_fusions);

  int process(Molecule& m, const Can_Change& can_change);
};

template <typename T>
Transformation_Create_Fused_Ring<T>::Transformation_Create_Fused_Ring(
    T& t, Molecule& m, resizable_array_p<Molecule>& f)
    : Transformation_and_Iterator<T, Iterate_Range>::_transform(
          Transformation_and_Iterator<T, Iterate_Range>(t)),
      Transformation_and_Iterator<T, Iterate_Range>::_iterator(
...
template <typename T>
int
Transformation_Create_Fused_Ring<T>::process(Molecule& m, const Can_Change& can_change) {
  int l;
...
template <typename T>
class Transformation_Add_Lib_Member
    : public Transformation_and_Iterator<T, Iterate_Range> {
 private:
  using Transformation_and_Iterator<T, Iterate_Range>::_transform;
  using Transformation_and_Iterator<T, Iterate_Range>::_iterator;
 ...
 public:
  Transformation_Add_Lib_Member(T& t, Molecule&, resizable_array_p<Molecule>&,
                                const bond_type_t);
...
template <typename T>
Transformation_Add_Lib_Member<T>::Transformation_Add_Lib_Member(
    T& t, Molecule& m, resizable_array_p<Molecule>& lib, const bond_type_t bt)
    : Transformation_and_Iterator<T, Iterate_Range>::_transform(
          Transformation_and_Iterator<T, Iterate_Range>(t)),
      Transformation_and_Iterator<T, Iterate_Range>::_iterator(
          Transformation_and_Iterator<T, Iterate_Range>(m.nrings())),
...
static int
exhaustive_application(Molecule& m, const Can_Change& can_change,
                       const int min_rings_this_molecule,
                       const int max_rings_this_molecule, const int depth) {
...
/*
  If the molecule looks closer to our target, we can add it to the global INPUT_MOLECULES
  array
*/

static int
check_proximity_to_target_set(
    Molecule& m, const int perturbation_number,
  ...
  if (stream_for_more_proximal_molecules.is_open()) {
    stream_for_more_proximal_molecules << m.smiles() << ' ' << m.name() << ' '
                                       << perturbation_number << ' ' << d << '\n';
...
Stream_of_Random_Numbers::Stream_of_Random_Numbers(const int imax)
    : _u(0, imax), _rng(rd()) {
}
...
// Randomly select a permutation and apply it to `m`.
// Update globals permutation_selected and permutation_successful.
template <typename C>
int
do_a_single_random_permutation(Molecule& m, const Can_Change& can_change,
                               C& transformation_chooser, RandomState& random_state) {
#ifdef FREQUENTLY_CHECK_VALENCES
  assert(m.valence_ok());
#endif
  ...
  while (1) {
    int p = 0;
    // cerr << "Smiles b4 " << m.smiles() << '\n';
    if (random_state.OkProbability(probability_inter_permutation)) {
      p = random_state.RandomInt(NUMBER_KNOWN_INTRA_PERMUTATIONS,
                                 number_known_permutations - 1);
    } else {  // an intra molecular transformation
      p = transformation_chooser();
    }

    ++permutation_selected[p];
    if (verbose > 2) {
    ...
    if (f(m, can_change, random_state)) {
      ++permutation_successful[p];
#ifdef FREQUENTLY_CHECK_VALENCES
      cerr << "Smiles after " << m.smiles() << '\n';
      assert(m.valence_ok());
#endif
      return 1;
    }
...
#ifdef FREQUENTLY_CHECK_VALENCES
    if (! m.valence_ok()) {
      cerr << "Bad valence detected " << m.smiles() << '\n';
    }
#endif
...
static int
do_the_output(Molecule& m, const int molecules_made, const int which_copy,
              const int which_permutation, Molecule_Output_Object& output) {
  const int matoms = m.natoms();
  ...
  tmp << mname << ' ' << molecules_made << " molecule " << molecules_read << " copy "
      << which_copy << " perm " << which_permutation;
...
static int
_violates_query_constraints(Molecule& m, const int min_rings_this_molecule,
                            const int max_rings_this_molecule) {
  const int nr = m.nrings();
#ifdef DEBUG_VIOLATES_QUERY_CONSTRAINTS
  cerr << nr << " rings, min_rings_this_molecule " << min_rings_this_molecule
       << " max_rings_this_molecule " << max_rings_this_molecule << '\n';
#endif
...
// #define KILL_PEROXIDES
  ...
  if (minimum_ring_size_allowed > 0 || maximum_ring_size_allowed > 0) {
    for (int i = 0; i < nr; i++) {
      ...
      if (maximum_ring_size_allowed > 0 &&
          ri->number_elements() >= maximum_ring_size_allowed) {
        return 1;
      }
    }
  }
...
static int
violates_query_constraints(Molecule& m, const int min_rings_this_molecule,
                           const int max_rings_this_molecule) {
  if (m.empty()) {
    return 1;
  }
...
template <typename C>
int
random_molecular_permutations(Molecule& m, const Can_Change& can_change, int istart,
                              const int min_rings_this_molecule,
                              const int max_rings_this_molecule,
                              C& transformation_chooser, RandomState& random_state,
  ...
  for (int i = 0; i < number_perturbations; i++) {
    if (!do_a_single_random_permutation(m, can_change, transformation_chooser,
                                        random_state)) {
      continue;
    }
...
template <typename C>
int
random_molecular_permutations(Molecule& m, const Can_Change& can_change,
                              int min_rings_this_molecule, int max_rings_this_molecule,
                              C& transformation_chooser, RandomState& random_state,
                              Molecule_Output_Object& output) {
#ifdef FREQUENTLY_CHECK_VALENCES
  assert(m.valence_ok());
  ...
  for (int i = 0; i < nstart; i++) {
    ...
    if (!random_molecular_permutations(mcopy, can_change, i, min_rings_this_molecule,
                                       max_rings_this_molecule, transformation_chooser,
                                       random_state, output)) {
      return 0;
    }
  }
...
static void
determine_min_and_max_rings(int nrings, int& min_rings_this_molecule,
...
template <typename C>
int
random_molecular_permutations(Molecule& m, C& transformation_chooser,
                              RandomState& random_state, Molecule_Output_Object& output) {
#ifdef FREQUENTLY_CHECK_VALENCES
  assert(m.valence_ok());
#endif
  ...
  determine_min_and_max_rings(m.nrings(), min_rings_this_molecule,
                              max_rings_this_molecule);

  if (verbose > 2) {
    cerr << "For a molecule with " << m.nrings() << " rings, nrings must be between "
         << min_rings_this_molecule << " and " << max_rings_this_molecule << '\n';
  }
  ...
  return random_molecular_permutations(m, can_change, min_rings_this_molecule,
                                       max_rings_this_molecule, transformation_chooser,
                                       random_state, output);
}
...
template <typename C>
int
random_molecular_permutations(C& transformation_chooser, RandomState& random_state,
                              Molecule_Output_Object& output) {
  for (int i = 0; i < input_molecules.number_elements();
       i++)  // not fixed size since it may grow
  {
    ...
    if (!random_molecular_permutations(*m, transformation_chooser, random_state,
                                       output)) {
      break;
    }
  ...
  for (int i = 0; i < iterations_through_new_molecules; ++i) {
    ...
    for (int j = 0; j < n; ++j) {
      Molecule mcopy(
          *closer_molecules.moleculei(j));  // need to create a copy since we might
                                            // replace ourselves in the closer set
      mcopy.set_name(closer_molecules.moleculei(j)->name());

      if (!random_molecular_permutations(mcopy, transformation_chooser, random_state,
                                         output)) {
        break;
      }
    }
...
template <typename C>
int
random_molecular_permutations(const Command_Line& cl, FileType input_type,
                              C& transformation_chooser, RandomState& random_state,
                              Molecule_Output_Object& output) {
  int rc = 0;
  for (int i = 0; i < cl.number_elements(); i++) {
    if (!random_molecular_permutations(cl[i], input_type, transformation_chooser,
                                       random_state, output)) {
      rc = i + 1;
      break;
    }
...
template <typename C>
int
random_molecular_permutations(const char* fname, FileType input_type,
                              C& transformation_chooser, RandomState& random_state,
                              Molecule_Output_Object& output) {
  ...
  return random_molecular_permutations(input, transformation_chooser, random_state,
                                       output);
}
...
read_transformation_probability_file_record(const const_IWSubstring& buffer) {
  ...
  if ("add_double_bond" == directive) {
    ...
    probability_break_aliphatic_ring = p;
    if (verbose) {
      cerr << "Probability of breaking aliphatic ring "
           << probability_break_aliphatic_ring << '\n';
    }
    ...
    if (verbose) {
      cerr << "Probability of destroying an aromatic ring "
           << probability_destroy_aromatic_ring << '\n';
    }
  } else if ("change_carbon_to_nitrogen" == directive) {
    probability_change_carbon_to_nitrogen = p;
    if (verbose) {
      cerr << "Probability of changing carbon to nitrogen "
           << probability_change_carbon_to_nitrogen << '\n';
    }
  } else if ("change_nitrogen_to_carbon" == directive) {
    probability_change_nitrogen_to_carbon = p;
    if (verbose) {
      cerr << "Probability of changing nitrogen to carbon "
           << probability_change_nitrogen_to_carbon << '\n';
    }
  } else if ("change_carbon_to_oxygen" == directive) {
    probability_change_carbon_to_oxygen = p;
    if (verbose) {
      cerr << "Probability of changing carbon to oxygen "
           << probability_change_carbon_to_oxygen << '\n';
    }
  } else if ("change_oxygen_to_something" == directive) {
    probability_change_oxygen_to_something = p;
    if (verbose) {
      cerr << "Probability of changing Oxygen to something else "
           << probability_change_oxygen_to_something << '\n';
    }
  } else if ("add_from_single_attachment_library" == directive) {
    probability_add_from_single_attachment_library = p;
    if (verbose) {
      cerr << "Probability of adding from single attachment library "
           << probability_add_from_single_attachment_library << '\n';
    }
  } else if ("add_from_aromatic_attachment_library" == directive) {
    probability_add_from_aromatic_attachment_library = p;
    if (verbose) {
      cerr << "Probability of adding from aromatic attachment library "
           << probability_add_from_aromatic_attachment_library << '\n';
    }
  } else if ("add_from_double_attachment_library" == directive) {
    probability_add_from_double_attachment_library = p;
    if (verbose) {
      cerr << "Probability of adding from double attachment library "
           << probability_add_from_double_attachment_library << '\n';
    }
  } else if ("change_ring_substitution" == directive) {
    probability_change_ring_substitution = p;
    if (verbose) {
      cerr << "Probability of changing ring substitution "
           << probability_change_ring_substitution << '\n';
    }
  } else if ("remove_terminal_functional_group" == directive) {
    probability_remove_terminal_functional_group = p;
    if (verbose) {
      cerr << "Probability of removing a terminal functional group "
           << probability_remove_terminal_functional_group << '\n';
    }
  } else if ("remove_embedded_functional_group" == directive) {
    probability_remove_embedded_functional_group = p;
    if (verbose) {
      cerr << "Probability of removing an embedded functional group "
           << probability_remove_embedded_functional_group << '\n';
    }
  } else if ("remove_terminal_ring" == directive) {
    probability_remove_terminal_ring = p;
    if (verbose) {
      cerr << "Probability of removing a terminal ring "
           << probability_remove_terminal_ring << '\n';
    }
  } else if ("switch_aromatic_ring" == directive) {
    probability_switch_aromatic_ring = p;
    if (verbose) {
      cerr << "Probability of switching an aromatic ring "
           << probability_switch_aromatic_ring << '\n';
    }
  } else if ("switch_aliphatic_ring" == directive) {
    probability_switch_aliphatic_ring = p;
    if (verbose) {
      cerr << "Probability of switching an aliphatic ring "
           << probability_switch_aliphatic_ring << '\n';
    }
    ...
    if (verbose) {
      cerr << "Probability of inter molecular permutation "
           << probability_inter_permutation << '\n';
    }
...
template <typename M>
int
read_fragments(data_source_and_type<M>& input, resizable_array_p<M>& molecules) {
  M* m;
...
template <typename M>
int
read_fragments(const IWString& fname, resizable_array_p<M>& m) {
...
static int
read_aromatic_ring_fusions(const_IWSubstring& fname, resizable_array_p<Molecule>& lib) {
  if (!read_fragments(fname, lib)) {
...
display_dash_T_options(std::ostream& output) {
  ...
  output << " -T write=<fname>    write all molecules added to the proximal collection "
            "to <fname>\n";
...
random_molecular_permutations(int argc, char** argv) {
  Command_Line cl(argc, argv, "vo:A:E:i:x:c:C:p:S:L:f:F:P:r:R:s:q:Q:K:y:Y:G:J:U:M:a:T:N:");
  ...
  if (cl.option_present('x')) {
    if (!cl.value('x', nstart) || nstart < 1) {
      cerr << "The number of copies of each molecule to start with (-x) must be a whole "
              "positive number\n";
      usage(15);
    }
  }
  ...
  if (cl.option_present('p')) {
    if (!cl.value('p', number_perturbations) || number_perturbations < 1) {
      cerr << "The number of permutations of each copy (-p) must be a positive whole "
              "number\n";
      usage(15);
    }
  }
  ...
  if (cl.option_present('M')) {
    ...
    while (cl.value('M', m, i++)) {
      if ("help" == m) {
        ...
        if (verbose) {
          cerr << "Will terminate processing if stop file '" << stop_file
               << "' present\n";
        }
        ...
        if (verbose) {
          cerr << "Will sequentially scan all " << NUMBER_KNOWN_INTRA_PERMUTATIONS
               << " intra molecular transformations\n";
        }
      } else if ("all" == m) {
  ...
  if (cl.option_present('r')) {
    ...
    if (verbose) {
      cerr << "Will never form a ring of size " << minimum_ring_size_allowed
           << " or smaller\n";
    }
  }
  ...
  if (cl.option_present('R')) {
    ...
    if (verbose) {
      cerr << "Will never form a ring of size " << maximum_ring_size_allowed
           << " or larger\n";
    }
  }

  if (cl.option_present('y')) {
    if (!cl.value('y', min_rings_in_each_permutation) ||
        min_rings_in_each_permutation < 1) {
      cerr << "The minimum number of rings (-y) option must be a whole positive number\n";
      usage(3);
    }

    if (verbose) {
      cerr << "Will discard any molecule having " << min_rings_in_each_permutation
           << " or fewer rings\n";
    }
  }

  if (cl.option_present('Y')) {
    if (!cl.value('Y', max_rings_in_each_permutation) ||
        max_rings_in_each_permutation < 1) {
      cerr << "The maximum number of rings (-Y) option must be a whole positive number\n";
      usage(3);
    }

    if (verbose) {
      cerr << "Will discard any molecule having " << max_rings_in_each_permutation
           << " or more rings\n";
    }
  }
  ...
  if (cl.option_present('T')) {
    ...
    for (int i = 0; cl.value('T', t, i); ++i) {
      ...
      if (t.starts_with("nmax=")) {
        ...
        if (!t.numeric_value(max_size_extra_molecules) || max_size_extra_molecules < 1) {
          cerr << "Max size of input molecule array (-T max=) must be a whole +ve "
                  "integer\n";
          usage(1);
        }
        ...
        if (!t.numeric_value(d) || d < 0.0f || d > 1.0f) {
          cerr << "The dmax (max distance to consider) option must contain a valid "
                  "distance\n";
          usage(1);
        }
        ...
        t.remove_leading_chars(5);
        if (!t.numeric_value(iterations_through_new_molecules) ||
            iterations_through_new_molecules < 1) {
          cerr
              << "The number of feedback iterations (fdbk=) must be a whole +ve number\n";
          display_dash_T_options(cerr);
        }
        if (verbose) {
          cerr << "Will iterate through accumulated proximal molecules "
               << iterations_through_new_molecules << " times\n";
        }
      } else if (t.starts_with("tom=")) {
        t.remove_leading_chars(4);
        if (!t.numeric_value(set_turn_off_molecules_matched_to_within) ||
            set_turn_off_molecules_matched_to_within < 0.0f ||
            set_turn_off_molecules_matched_to_within > 1.0f) {
          cerr << "The turn off if matched within option (zwd=) must be a valid "
                  "distance\n";
          display_dash_T_options(cerr);
        }
        if (verbose) {
          cerr << "Ay target molecule matched to within "
               << set_turn_off_molecules_matched_to_within
    ...
    if (verbose) {
      cerr << "Read " << set_of_target_molecules.number_molecules()
           << " target molecules from '" << fname << "'\n";
    }
    ...
    if (set_turn_off_molecules_matched_to_within > 0.0f) {
      set_of_target_molecules.set_turn_off_molecules_matched_to_within(
          set_turn_off_molecules_matched_to_within);
    }
  }
  ...
  if (cl.option_present('G')) {
    ...
    while (cl.value('G', g, i++)) {
      if (g.starts_with('+')) {
        ...
        if (verbose) {
          cerr << "Will discard molecules that have more than " << max_rings_to_add
               << " extra rings over the starting molecule\n";
        }
        ...
        if (verbose) {
          cerr << "Will discard molecules that have lost more than "
               << max_rings_to_remove << " rings from the starting molecule\n";
        }
  ...
  if (cl.option_present('L')) {
    ...
    while (cl.value('L', l, i++)) {
      if (l.starts_with("single=")) {
        ...
        if (!read_single_attachment_library(
                l, single_attachment_fragment_library_join_at_first_atom,
                1))  // 1 means first atom must have hydrogen
        {
        ...
        if (verbose) {
          cerr << "Read "
               << single_attachment_fragment_library_join_at_first_atom.number_elements()
               << " singly attached fragments from '" << l << "'\n";
        }
      } else if (l.starts_with("singleR=")) {
        l.remove_up_to_first('=');
        if (!read_single_attachment_library(
                l, single_attachment_fragment_library_join_from_any_atom,
                0))  // 0 means first atom does not need to have a hydrogen
        {
          cerr << "Cannot read singly bonded attachments from '" << l << "'\n";
          return 1;
        }
        ...
        if (verbose) {
          cerr << "Read "
               << single_attachment_fragment_library_join_from_any_atom.number_elements()
               << " singly attached (any atom) fragments from '" << l << "'\n";
        }
        ...
        if (verbose) {
          cerr << "Read " << double_attachment_fragment_library.number_elements()
               << " doubly connected attachment fragments from '" << l << "'\n";
        }
        ...
        if (verbose) {
          cerr << "Read " << aromatic_attachment_fragment_library.number_elements()
               << " aromatic attachment fragments from '" << l << "'\n";
        }
        ...
        if (verbose) {
          cerr << "Read " << aromatic_rings.number_elements() << " aromatic rings from '"
               << l << "'\n";
        }
        ...
        if (verbose) {
          cerr << "Read " << aliphatic_rings.number_elements()
               << " aliphatic rings from '" << l << "'\n";
        }
        ...
        if (verbose) {
          cerr << "Read " << aromatic_ring_fusions.number_elements()
               << " aromatic ring fusions from '" << l << "'\n";
        }
      } else {
  ...
  if (single_attachment_fragment_library_join_at_first_atom.empty() &&
      0.0 != probability_add_from_single_attachment_library) {
    cerr << "No single attachment fragments available, probability set to 0.0\n";

    probability_add_from_single_attachment_library = 0.0;
  }

  if (double_attachment_fragment_library.empty() &&
      0.0 != probability_add_from_double_attachment_library) {
    cerr << "No double attachment fragments available, probability set to 0.0\n";

    probability_add_from_double_attachment_library = 0.0;
  }

  if (aromatic_attachment_fragment_library.empty() &&
      0.0 != probability_add_from_aromatic_attachment_library) {
  ...
  if (cl.option_present('F')) {
    ...
    if (verbose) {
      cerr << "Defined " << never_change_query.number_elements()
           << " queries for fixed atoms\n";
    }
  }
  ...
  if (!cl.option_present('C')) {
    ...
    cerr << "Will exclude molecules with more than " << upper_atom_count_cutoff
         << " atoms\n";
  }
  ...
  std::fill_n(permutation_selected, NUMBER_KNOWN_PERMUTATIONS, 0);
  std::fill_n(permutation_successful, NUMBER_KNOWN_PERMUTATIONS, 0);
  ...
  if (verbose) {
    ...
    cerr << "Input molecules had between " << atoms_in_starting_molecules.minval()
         << " and " << atoms_in_starting_molecules.maxval();
    if (atoms_in_starting_molecules.n() > 1) {
      cerr << " ave " << atoms_in_starting_molecules.average();
    }
    cerr << " atoms\n";
    cerr << "Final molecules had between " << atoms_in_molecules_written.minval()
         << " and " << atoms_in_molecules_written.maxval();
    ...
    if (verbose > 1) {
      ...
      if (molecules_with_too_many_rings) {
        cerr << molecules_with_too_many_rings
             << " permutations which had too many rings\n";
      }
    }

    if (acc_dist_to_target.n()) {
      cerr << acc_dist_to_target.n() << " shortest distances to target molecules, btw "
           << acc_dist_to_target.minval() << " and " << acc_dist_to_target.maxval()
           << " ave " << static_cast<float>(acc_dist_to_target.average()) << '\n';
    }

#ifdef WHEN_WE_GET_TRANSFORMATION_CLASSES_IMPLEMENTED
    for (int i = 0; i < NUMBER_KNOWN_PERMUTATIONS; ++i) {
      cerr << i << ' ';
      known_permutation[i].report(cerr);
    }
#endif
    for (int i = 0; i < NUMBER_KNOWN_PERMUTATIONS; ++i) {
      cerr << "Permutation" << '\t' << i << '\t' << permutation_name[i] << 
              '\t' << "attempted " << permutation_selected[i] <<
              '\t' << "successful" << '\t' << permutation_successful[i] << '\t' <<
              Fraction<float>(permutation_successful[i], permutation_selected[i]) <<
              '\n';
    }
  }
