...
template int queries_from_file_of_molecules<Substructure_Query>(const_IWSubstring const &, resizable_array_p<Substructure_Query> &, int, Molecule_to_Query_Specifications* mqs);
...
template int query_from_molecule<Substructure_Query>(MDL_Molecule &, Molecule_to_Query_Specifications  &, resizable_array_p<Substructure_Query> &);
