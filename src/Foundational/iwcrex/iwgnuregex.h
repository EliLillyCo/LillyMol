...
//  private functions
  ...
  public:
    IW_gnu_regex ();
    IW_gnu_regex (const char *);
    IW_gnu_regex (const char *, int);
    IW_gnu_regex (const const_IWSubstring &);
    IW_gnu_regex (const IWString &);
    ~IW_gnu_regex ();
...
extern int iwcrex_s (IWString &, IW_gnu_regex &, const const_IWSubstring &);

// Result put in a new variable

extern int iwcrex_s (const IWString &, IW_gnu_regex &, const const_IWSubstring &, IWString &);
