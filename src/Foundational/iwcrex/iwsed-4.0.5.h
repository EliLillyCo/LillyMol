...
//  private functions
  ...
  public:
    IW_sed_405_regex ();
    IW_sed_405_regex (const char *);
    IW_sed_405_regex (const char *, int);
    IW_sed_405_regex (const const_IWSubstring &);
    IW_sed_405_regex (const IWString &);
    ~IW_sed_405_regex ();
...
extern int iwcrex_s (IWString &, IW_sed_405_regex &, const const_IWSubstring &);

// Result put in a new variable

extern int iwcrex_s (const IWString &, IW_sed_405_regex &, const const_IWSubstring &, IWString &);
