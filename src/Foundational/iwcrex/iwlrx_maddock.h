#ifndef IW_RX_LRX_MADDOCK_H
#define IW_RX_LRX_MADDOCK_H
...
//  private functions
  ...
  public:
    IW_lrx_Maddock ();
    IW_lrx_Maddock (const char *);
    IW_lrx_Maddock (const char *, int);
    IW_lrx_Maddock (const const_IWSubstring &);
    IW_lrx_Maddock (const IWString &);
    ~IW_lrx_Maddock ();
...
extern int iwcrex_s (IWString &, IW_lrx_Maddock &, const const_IWSubstring &);

// Result put in a new variable

extern int iwcrex_s (const IWString &, IW_lrx_Maddock &, const const_IWSubstring &, IWString &);
