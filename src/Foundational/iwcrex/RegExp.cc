...
#define TRACE0(_s) { cerr << _s;}
#define TRACE1(_s, _v) { cerr << _s << _v ;}

#define _tcslen(s) ::strlen(s)
#define _tcscspn(s, r) ::strcspn(s, r)
#define _tcsncpy(t, f, n) :: strncpy(t, f, n)
#define _tcsstr(n, h) strstr(n, h)
#define _tcschr(s, c) strchr(s, c)
#define _tcsncmp(s1, s2, n) ::strncmp(s1, s2, n)
#define _tcsspn(s1, s2) ::strspn(s1, s2)
