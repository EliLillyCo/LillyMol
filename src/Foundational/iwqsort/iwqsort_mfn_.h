#ifndef IWQSORT_MFN_IMPLEMENTATION_H
#define IWQSORT_MFN_IMPLEMENTATION_H


#include "iwqsort_mfn.h"
...
#ifdef IWQS_USER_FUNCTION_SUPPLIED
  iwqsort_mfn (t, right - low, mfn);
  iwqsort_mfn (t + right + 1, n - right - 1, mfn);
#else
  iwqsort_mfn (t, right - low);
  iwqsort_mfn (t + right + 1, n - right - 1);
#endif
