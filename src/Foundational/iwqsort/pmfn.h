#ifndef IWQSORT_PMFN_IMPLEMENTATION_H
#define IWQSORT_PMFN_IMPLEMENTATION_H


#include "iwqsort_pmfn.h"
#define IWQS_USER_FUNCTION_SUPPLIED
...
#ifdef IWQS_USER_FUNCTION_SUPPLIED
  iwqsort_pmfn (t, right - low, mfn);
  iwqsort_pmfn (t + right + 1, n - right - 1, mfn);
#else
  iwqsort_pmfn (t, right - low);
  iwqsort_pmfn (t + right + 1, n - right - 1);
#endif
