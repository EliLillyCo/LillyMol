            ...
            IW_TDT_Filter & filter)
{
  ...
  return build_pool(input, filter);
}
...
{
  Command_Line cl (argc, argv, "vs:I:E:t:F:P:W:X:rH:S:C:O:Y:V:R:m:M:A:L:a:D:");
...
// that the pool is built first
  ...
  if (! build_pool(cl[0], pool_file, filter) || 0 == pool_size)
  {
