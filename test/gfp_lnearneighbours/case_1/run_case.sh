...
command=$BIN_DIR/gfp_lnearneighbours
case_id="Case 1"
...
$command -F FPDSC,w=0.3 -F NCSELW,nc,w=0.7 -T 0.4 -n 2 -h -p $shared_data_dir/pubchem.gfp $shared_data_dir/pubchem.gfp >out.txt 2>err.log
