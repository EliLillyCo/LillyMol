...
test_command=remove_matched_atoms
case=case_1
case_id="Case 1"
...
out=stripped_matches.smi
cmp_out="$test_cmd_top/$case/out/stripped_matches.smi"

echo "Testing: $command"

$command -s 'CC1CCCNC1' -S stripped_matches "$in" 2>>err.txt
