...
gold_out="${test_cmd_top}/${case}/out/dalke_case4.series"
stdout='dalke_case4.series'
stderr='stderr'

echo "Testing: $command"

$command -i "$in" -o "${stdout}" -s SMILES -n CHEMBL_ID -a hERG_pIC50 -y -p 4 -q 5 -z "${test_cmd_top}/${case}/in/queries" 2> ${stderr}
