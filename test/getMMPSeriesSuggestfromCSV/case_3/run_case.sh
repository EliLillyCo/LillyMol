...
gold_out="${test_cmd_top}/${case}/out/dalke_case3.series"
stdout='dalke_case3.series'
stderr='stderr'

echo "Testing: $command"

${command} -i "${in}" -o "${stdout}" -s SMILES -n CHEMBL_ID -a hERG_pIC50 -p 5 -q 9 -x '3612928,3612926,3612807,3612927' 2> ${stderr}
